...
Component({
  ...
  methods: {
    ...
    tapBtn1(e) {
      this.triggerEvent('tapBtn1', e.currentTarget.dataset.item);
    },
    tapBtn2(e){
      this.triggerEvent('tapBtn2', e.currentTarget.dataset.item);
    },
    tapBtn3(e) {
      this.triggerEvent('tapBtn3', e.currentTarget.dataset.item);
    },
    // 将非标准值标准化
    normalizeValue() {
      return toTree({
